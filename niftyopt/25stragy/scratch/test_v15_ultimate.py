...
# Implement the Ultimate Unified Engine logic in run_index
def run_index_ultimate(idx_name: str, opt_data: pd.DataFrame, eod_data: pd.DataFrame, cfg: bt.IndexConfig):
    ...
    for day in trading_days:
        ...
        # On Expiry Day: Active strategies = ONLY ZERO_HERO and GAMMA_BLAST
        # On Normal Day: Active strategies = All 23 strategies
        if expiry:
...
bt.run_index = run_index_ultimate

def run_test_ultimate():
    print("\n" + "="*70)
    print("RUNNING ULTIMATE UNIFIED ENGINE (Expiry-Only + Hybrid Mixed)")
    print("  Capital per index: Rs. 150,000 | Max Lots Cap: 60")
    print("  Daily Loss Limit (Circuit Breaker): Rs. -9,000")
    print("="*70)
