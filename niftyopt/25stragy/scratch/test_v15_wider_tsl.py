...
# Define the new execute_tsl_idx with UNCAPPED TSL parameters for breathing room
def execute_tsl_idx_v15_wider(entry_bar: pd.Series, remaining: pd.DataFrame, hard_exit: int = 1430, 
    ...
    # DO NOT CAP AT 6% AND 4%! Let the DNA values rule!
...
bt.execute_tsl_idx = execute_tsl_idx_v15_wider
...
def main():
    print("=" * 70)
    print("RUNNING V15 WIDER/UNCAPPED TSL BACKTEST")
    print("=" * 70)
