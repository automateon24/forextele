...
# Set max lots cap to 50 in memory
bt.MAX_LOTS_CAP = 50
...
# Update config.json system settings for this test
config['system']['max_lots_cap'] = 50
config['index_profiles']['NIFTY']['active_strategies'] = final_active_23
...
def main():
    print("=" * 70)
    print("RUNNING V15 MAX_LOTS_CAP = 50 BACKTEST")
    print("=" * 70)
