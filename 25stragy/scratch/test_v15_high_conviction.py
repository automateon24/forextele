...
# Enforce ENABLE_THRESH_RELAX = True and see what it is
bt.ENABLE_THRESH_RELAX = True
...
def main():
    print("=" * 70)
    print("RUNNING V15 HIGH CONVICTION / CONFIRMATION BACKTEST")
    print("  ENABLE_THRESH_RELAX = True")
    print("=" * 70)
