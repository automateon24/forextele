...
ENABLE_REGIME_SCALING = os.environ.get("ENABLE_REGIME_SCALING", "TRUE").upper() == "TRUE"
ENABLE_EXPIRY_UNCAP = os.environ.get("ENABLE_EXPIRY_UNCAP", "TRUE").upper() == "TRUE"
EXPIRY_UNCAP_TIGHT = os.environ.get("EXPIRY_UNCAP_TIGHT", "FALSE").upper() == "TRUE"
ENABLE_THRESH_RELAX = os.environ.get("ENABLE_THRESH_RELAX", "TRUE").upper() == "TRUE"
