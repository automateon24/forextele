...
# Define execute_tsl_idx with Spot-Based Stop Loss
def execute_tsl_idx_v15_spot_sl(entry_bar: pd.Series, remaining: pd.DataFrame, hard_exit: int = 1430, 
...
bt.execute_tsl_idx = execute_tsl_idx_v15_spot_sl
...
def main():
    print("=" * 70)
    print("RUNNING V15 SPOT-BASED STOP LOSS BACKTEST")
    print("=" * 70)
