...
# Ensure we are running in the correct directory (root of forextele)
...
class SwarmThreadManager:
    def __init__(self):
        ...
        self.services = {
            ...
            "SVC_MARKET_DATA": "src/strategy/market_data.py", # Phase 1: MT5 Oracle
            "SVC_PORTFOLIO": "src/portfolio/manager.py",      # Phase 2: Portfolio State Manager
            "SVC_STRATEGY": "src/strategy/engine.py",         # Phase 1: Pure Signal Logic
            "SVC_RISK": "src/risk/engine.py",                 # Phase 1/2: Risk Enforcer
            "SVC_EXECUTION": "src/execution/gateway.py",      # Phase 1: MT5 Execution Gateway
