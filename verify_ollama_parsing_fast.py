...
OUTPUT_CSV = "ollama_fast_verification.csv"
MSG_LIMIT = 5
...
async def fetch_and_test():
    ...
    with open(OUTPUT_CSV, "w", newline='', encoding="utf-8") as f:
        writer = csv.DictWriter(f, fieldnames=["Channel", "Raw_Message", "Status", "Reason", "Symbol", "Action", "Entry", "SL", "TP"])
        writer.writeheader()
        ...
        for client in clients:
            ...
            for dialog in dialogs:
                ...
                print(f"Sampling {MSG_LIMIT} msgs from: {safe_title}")
                
                try:
                    async for msg in client.iter_messages(chat, limit=MSG_LIMIT):
                        if msg.text:
    ...
    print("Fast verification complete.")
